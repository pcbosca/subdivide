...
Using vertices to create regularly distributed camera positions
*/
...
void keyboard(unsigned char key, int x, int y)
{
    ...
    case '+':
        if (subdiv < MAX_SUBDIVS) subdiv++;
            ...
            fprintf(stdout, "Can't increase subdivisions beyond MAX = %d\n", MAX_SUBDIVS);
        }
        fprintf(stdout, "Number of subdivisions = %d\n", subdiv);
        break;
    case '-':
        subdiv--;
    ...
    case 'w':
        ...
        fprintf(stdout, "Removing repeated vertices...\n");
